...
const Home = () => {
    const setData = () =>{
        ...
        let invoice = [{"invoice_id":1,"invoice_date":"25/05/2021","invoice_time":"11:52 PM","invoice_customer":{"name":"Asif Salman Malik","address":"Babu Para, Alamdanga, Chuadanga.","mobile":"01770810050"},"invoice_items":[{"product_name":"Lux Beauty Soap(Rose) - 125g","product_purchase":30.78,"product_sale":35,"product_quantity":19,"product_unit":"Pcs","cart_qty":2}],"invoice_discount":0},{"invoice_id":2,"invoice_date":"25/05/2021","invoice_time":"11:52 PM","invoice_customer":{"name":"Shuvo","address":"Shampur, Alamdanga, Chuadanga.","mobile":"01858104363"},"invoice_items":[{"product_name":"Lux Beauty Soap(Rose) - 125g","product_purchase":30.78,"product_sale":35,"product_quantity":19,"product_unit":"Pcs","cart_qty":3}],"invoice_discount":0},{"invoice_id":3,"invoice_date":"25/05/2021","invoice_time":"11:52 PM","invoice_customer":{"name":"Asif Salman Malik","address":"Babu Para, Alamdanga, Chuadanga.","mobile":"01770810050"},"invoice_items":[{"product_name":"Lux Beauty Soap(Rose) - 125g","product_purchase":30.78,"product_sale":35,"product_quantity":19,"product_unit":"Pcs","cart_qty":1}],"invoice_discount":0}];
        if(!invoice.length){
